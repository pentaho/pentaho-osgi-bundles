...
/**
 * The i18N DUMMY data service
 *
 * Use while i18n service is TBD
 *
 * @module i18nMock
 * @property {Function} load Loads the i18n definitions
 * @property {Function} normalize Normalizes the i18n ID
 */
define(["pentaho/util/MessageBundle", "text"], function(MessageBundle) {
  return {
