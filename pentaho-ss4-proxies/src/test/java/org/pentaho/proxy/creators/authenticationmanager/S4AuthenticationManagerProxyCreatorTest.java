...
public class S4AuthenticationManagerProxyCreatorTest {
  ...
  @Test public void testCreateProxyWrapper() {
    ...
    AuthenticationManager wrappedObject = new S4AuthenticationManagerProxyCreatorForTest().create( mockAuthenticationManager );
  ...
  private class S4AuthenticationManagerProxyCreatorForTest extends S4AuthenticationManagerProxyCreator{
