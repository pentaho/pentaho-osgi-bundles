...
import org.pentaho.proxy.creators.authenticationentrypoint.S4AuthenticationExceptionProxyCreator;
...
public class S4AuthenticationExceptionProxyCreatorTest {
  ...
  @Test public void testCreateProxyWrapper() {
    ...
    AuthenticationException wrappedObject = new S4AuthenticationExceptionProxyCreatorForTest().create( mockAuthenticationException );
  ...
  private class S4AuthenticationExceptionProxyCreatorForTest extends S4AuthenticationExceptionProxyCreator {
