...
import org.pentaho.proxy.creators.securitycontext.S4SecurityContextProxyCreator;
...
public class S4SecurityContextProxyCreatorTest {
  ...
  @Test public void testCreateProxyWrapper() {
    ...
    SecurityContext wrappedObject = new S4SecurityContextProxyCreatorForTest().create( mockSecurityContext );
  ...
  private class S4SecurityContextProxyCreatorForTest extends S4SecurityContextProxyCreator {
