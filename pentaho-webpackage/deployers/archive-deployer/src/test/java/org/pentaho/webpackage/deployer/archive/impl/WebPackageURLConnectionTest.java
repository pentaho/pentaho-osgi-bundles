...
public class WebPackageURLConnectionTest {
  ...
  private void verifyManifest( Manifest manifest, String moduleName, String moduleVersion ) {
    ...
    assertTrue( manifest.getMainAttributes().getValue( Constants.PROVIDE_CAPABILITY ).startsWith( PentahoWebPackageBundle.CAPABILITY_NAMESPACE + ";name=\"" + moduleName + "\";version:Version=\"" + moduleVersion + "\";root=\"/pwp-" ) );
  }
