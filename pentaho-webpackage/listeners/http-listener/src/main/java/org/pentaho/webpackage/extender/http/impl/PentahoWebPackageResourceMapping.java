...
public class PentahoWebPackageResourceMapping implements ResourceMapping {
  ...
  public String getAlias() {
    return "/" + this.pentahoWebPackage.getName() + "/" + this.pentahoWebPackage.getVersion();
  }
  ...
  public PentahoWebPackage getPentahoWebPackage() {
    return this.pentahoWebPackage;
  }
  ...
  public boolean equals(Object obj) {
    if (this == obj) {
      ...
      return other.getPentahoWebPackage().equals( this.getPentahoWebPackage() );
    }
  }
