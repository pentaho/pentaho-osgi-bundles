...
//
//  private PentahoWebPackageServiceTracker service;
...
//
//    this.service = new PentahoWebPackageServiceTracker( context );
//    this.serviceRegistrationMap = new HashMap<>();
//  }
//
//  @Test
//  public void bundleStarted() {
//    PentahoWebPackageServiceTracker spyed = spy( this.service );
//
...
//      }
//
//      capabilitiesHeader.add( PentahoWebPackageBundleListener.CAPABILITY_NAMESPACE + ";root=\"" + root + "\"" );
//
...
//    } );
//
//    when( wiring.getCapabilities( PentahoWebPackageBundleListener.CAPABILITY_NAMESPACE ) ).thenReturn( bundleCapabilities );
//
