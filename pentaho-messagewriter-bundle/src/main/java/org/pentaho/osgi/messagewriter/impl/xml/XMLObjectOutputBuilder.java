 ...
 */
public class XMLObjectOutputBuilder extends XMLOutputBuilder implements ObjectOutputBuilder {
  private final Node parentNode;

  public XMLObjectOutputBuilder( Document document, Node parentNode ) {
    super( document );
    this.parentNode = parentNode;
  }

  @Override public void set( Object value ) throws OutputException {
    new Outputter( new XMLOutputBuilderFactory( getDocument(), parentNode ) ).set( value );
  }
}
