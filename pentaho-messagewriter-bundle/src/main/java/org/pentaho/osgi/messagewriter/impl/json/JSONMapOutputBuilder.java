 ...
 */
public class JSONMapOutputBuilder extends JSONOutputBuilder implements MapOutputBuilder {
  ...
  @Override public void put( String key, Object value ) throws OutputException {
    ...
    jsonObjectOutputBuilder.set( value );
    jsonObject.put( key, jsonObjectOutputBuilder.getJSONStreamAware() );
  }
