 ...
 */
public class XMLPrimitiveOutputBuilder extends XMLOutputBuilder implements PrimitiveOutputBuilder {
  private final Node parentNode;

  public XMLPrimitiveOutputBuilder( Document document, Node parentNode ) {
    super( document );
