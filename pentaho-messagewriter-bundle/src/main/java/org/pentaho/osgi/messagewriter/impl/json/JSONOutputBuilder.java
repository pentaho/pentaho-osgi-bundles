 ...
 */
public abstract class JSONOutputBuilder implements OutputBuilder {

  @Override public void write( OutputStream outputStream ) throws IOException {
    OutputStreamWriter outputStreamWriter = new OutputStreamWriter( outputStream );
    getJSONStreamAware().writeJSONString( outputStreamWriter );
    outputStreamWriter.flush();
  }

  public abstract JSONStreamAware getJSONStreamAware();
}
