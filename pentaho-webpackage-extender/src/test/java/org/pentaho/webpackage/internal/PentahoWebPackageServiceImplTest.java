...
public class PentahoWebPackageServiceImplTest {
  ...
  public void addWebPackageBundle() {
    ...
    capabilities.add( createMockWebPackageCapability( "/pentaho-web-package-1a" ) );
    capabilities.add( createMockWebPackageCapability( "/pentaho-web-package-1b" ) );
    capabilities.add( createMockWebPackageCapability( "/pentaho-web-package-1c" ) );
    Bundle bundle = this.createMockWebPackageBundle( capabilities, "pentaho-web-package-1", "1.0", Bundle.ACTIVE );
    ...
    assertResourceMappingExists( capturedResourceMappings, "/pentaho-web-package-1a", "/package-name-1a/1.0" );
    assertResourceMappingExists( capturedResourceMappings, "/pentaho-web-package-1b", "/package-name-1b/1.1" );
    assertResourceMappingExists( capturedResourceMappings, "/pentaho-web-package-1c", "/package-name-1c/1.2" );
  }
  ...
  public void removeWebPackageBundle() {
    ...
    verify( this.serviceRegistrationMap.get( "/pentaho-web-package-1a" ), times( 1 ) ).unregister();
    verify( this.serviceRegistrationMap.get( "/pentaho-web-package-1b" ), times( 1 ) ).unregister();
    verify( this.serviceRegistrationMap.get( "/pentaho-web-package-1c" ), times( 1 ) ).unregister();
  }
  ...
  private Bundle createMockWebPackageBundle( List<BundleCapability> capabilities, String bundleName, String bundleVersion, int bundleState ) {
    ...
    capabilities.forEach( bundleCapability -> {
      ...
      capabilitiesHeader.add( "org.pentaho.webpackage;root=\"" + root + "\"" );

      when( mockBundle.getResource( root + "/package.json" ) ).thenReturn( this.getClass().getClassLoader().getResource( "./" + root + "-package.json" ) );
    } );
