...
public abstract class AbstractMessageListenerFactory<K, V, L extends AbstractMessageListener> {
   ...
   * @return should return an instance of the <L extends {@link AbstractMessageListener}> type.
   */
  protected abstract L getMessageListenerInstance();

  /**
   * Gets an instance of the parametrized {@link AbstractMessageListener} with the local consumer factory
   * and topic setup.
   * @param topic the topic to associate to the listener.
   * @return A {@link AbstractMessageListener} instance of the type parametrized.
   */
